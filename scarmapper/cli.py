...
from Valkyries import Tool_Box, Version_Dependencies as VersionDependencies
...
def main(command_line_args=None):
    ...
    log.info(f"****ScarMapper complete ({elapsed} seconds, {Tool_Box.peak_memory()} Mb peak memory).****{warning}")
